...
-(void)paymentSuccess:(NSString *)transactionID {
    ...
    */
	...
	OrderResultsViewController *orderResultsViewController = [[[OrderResultsViewController alloc] initWithNibName:@"OrderResultsViewController"
                                                                                                           bundle:nil] autorelease];

    UIDevice *myDevice = [UIDevice currentDevice];
	NSString *deviceUDID = [myDevice uniqueIdentifier];
    
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@?paypal_id=%@&hardware_id=%@", returnURL, transactionID, deviceUDID]];
